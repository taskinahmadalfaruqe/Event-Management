  ...
  return (
    <div className=" mt-5 relative flex flex-col  w-full  lg:flex-row rounded-xl bg-white bg-clip-border text-black shadow-md">
      ...
      <div className="relative p-2 w-full m-0 lg:w-2/5 shrink-0 overflow-hidden rounded-md rounded-r-none bg-white bg-clip-border">
        ...
        <p className="text-2xl font-bold uppercase  text-white p-2 px-4 ">{price} BDT</p>
        </div>
      </div>
      ...
      <div className="p-1 md:p-5 lg:p-6 space-y-5">
        ...
        <p className="mb-8 block font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
          {
          description.length>100 ? <p>{description.slice(0,100)}....</p>:description
          }
        </p>
        
        <div className="text-base">
            <h2 className="text-2xl font-semibold  text-purple-500">We Will Do For You</h2>
            {
                willDo.map((data,index)=>  <p className="pl-3  font-medium" key={index}>{++count}: {data}</p>)
            }
            And More.......
        </div>
