  ...
  return (
    <div className=" font-Oswald flex justify-between items-center">
      ...
      <div className="dropdown">
          <label tabIndex={0} className="btn btn-ghost lg:hidden text-2xl bg-purple-200">
            <LiaBarsSolid></LiaBarsSolid>
          </label>
          <ul
            tabIndex={0}
            className="dropdown-content rounded-md  z-[1] p-3 shadow bg-slate-100  absolute top-14 w-[50vw] text-center right-0"
          >
            {NavBar}
          </ul>
        </div>
